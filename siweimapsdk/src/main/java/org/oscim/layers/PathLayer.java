...
public class PathLayer extends Layer implements GestureListener {
    ...
    public PathLayer(SiweidgMap map, LineStyle style) {
        super(map);
        mLineStyle = style;
    ...
    public PathLayer(SiweidgMap map, int lineColor, float lineWidth) {
        this(map, new LineStyle(lineColor, lineWidth, Cap.BUTT));
    }

    public PathLayer(SiweidgMap map, int lineColor) {
