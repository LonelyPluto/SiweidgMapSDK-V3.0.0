...
public class VectorTileLayer extends TileLayer {
    ...
    public VectorTileLayer(SiweidgMap map, TileSource tileSource) {
    ...
    public VectorTileLayer(SiweidgMap map, int cacheLimit) {
        this(map, new TileManager(map, cacheLimit),
                new VectorTileRenderer());
    }

    public VectorTileLayer(SiweidgMap map, TileManager tileManager,
