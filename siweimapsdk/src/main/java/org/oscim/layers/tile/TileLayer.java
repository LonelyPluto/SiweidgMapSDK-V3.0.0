...
import com.siweidg.siweimapsdk.map.SiweidgMap.UpdateListener;
...
public abstract class TileLayer extends Layer implements UpdateListener {
    ...
    public TileLayer(SiweidgMap map, TileManager tileManager, TileRenderer renderer) {
        super(map);
    ...
    public TileLayer(SiweidgMap map, TileManager tileManager) {
        super(map);
        mTileManager = tileManager;
    }
    ...
    public void onMapEvent(Event event, MapPosition mapPosition) {
        ...
        } else if (event == SiweidgMap.POSITION_EVENT) {
            if (mTileManager.update(mapPosition))
                notifyLoaders();
        }
    }
