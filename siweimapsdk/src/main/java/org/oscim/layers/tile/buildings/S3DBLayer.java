...
public class S3DBLayer extends BuildingLayer {
    ...
    public S3DBLayer(SiweidgMap map, VectorTileLayer tileLayer) {
        this(map, tileLayer, false);
    }

    public S3DBLayer(SiweidgMap map, VectorTileLayer tileLayer, boolean shadow) {
     ...
     */
    public S3DBLayer(SiweidgMap map, VectorTileLayer tileLayer, int zoomMin, int zoomMax, boolean shadow) {
