...
public class BuildingLayer extends Layer implements TileLoaderThemeHook, ZoomLimiter.IZoomLimiter {
     ...
     * {@link RenderBucket#EXTRUSION}: roofs are always translucent.
     * <p>
    ...
    public BuildingLayer(SiweidgMap map, VectorTileLayer tileLayer) {
        this(map, tileLayer, false, false);
    }

    public BuildingLayer(SiweidgMap map, VectorTileLayer tileLayer, boolean mesh, boolean shadow) {
     ...
     */
    public BuildingLayer(SiweidgMap map, VectorTileLayer tileLayer, int zoomMin, int zoomMax, boolean mesh, boolean shadow) {
        super(map);
