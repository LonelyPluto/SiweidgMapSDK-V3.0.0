...
public class LabelLayer extends Layer implements SiweidgMap.UpdateListener, TileManager.Listener,
    ...
    public LabelLayer(SiweidgMap map, VectorTileLayer l) {
        this(map, l, new LabelTileLoaderHook());
    }

    public LabelLayer(SiweidgMap map, VectorTileLayer l, VectorTileLayer.TileLoaderThemeHook h) {
    ...
    public void onMapEvent(Event event, MapPosition mapPosition) {
        ...
        if (event == SiweidgMap.CLEAR_EVENT)
            mWorker.cancel(true);
