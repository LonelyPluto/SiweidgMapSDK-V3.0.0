...
public class TileGridLayer extends GenericLayer {
    ...
    public TileGridLayer(SiweidgMap map) {
        super(map, new GridRenderer());
    }

    public TileGridLayer(SiweidgMap map, float scale) {
        super(map, new GridRenderer(scale));
    }

    public TileGridLayer(SiweidgMap map, int color, float width, int repeat) {
        super(map, new GridRenderer(repeat, new LineStyle(color, width, Cap.BUTT), null));
    }

    public TileGridLayer(SiweidgMap map, int color, float width, TextStyle text, int repeat) {
