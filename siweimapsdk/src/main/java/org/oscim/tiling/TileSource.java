...
import com.siweidg.siweimapsdk.dbdata.IMapTileProvider;
...
public abstract class TileSource {
    ...
    private IMapTileProvider mapTileFileProvider;// db文件
    ...
    /**
     * MapTileDBProvider MUST be set before TileSource is added to a TileLayer!
     */
    public void setMapTileFileProvider(IMapTileProvider mapTileFileProvider) {
        this.mapTileFileProvider = mapTileFileProvider;
    }

    public ITileCache getCache() {
        return tileCache;
    }

    public IMapTileProvider getMapTileFileProvider() {
        return mapTileFileProvider;
    }
