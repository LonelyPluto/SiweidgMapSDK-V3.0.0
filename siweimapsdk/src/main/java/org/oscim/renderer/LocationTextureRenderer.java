...
public class LocationTextureRenderer extends BucketRenderer {
    ...
    public LocationTextureRenderer(SiweidgMap map, Layer layer) {
        this(map, layer, CanvasAdapter.getScale());
    }

    public LocationTextureRenderer(SiweidgMap map, Layer layer, float scale) {
        mMap = map;
        mLayer = layer;
        mScale = scale;
