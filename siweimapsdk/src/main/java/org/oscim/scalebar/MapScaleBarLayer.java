...
public class MapScaleBarLayer extends Layer implements SiweidgMap.UpdateListener {
    private final MapScaleBar mapScaleBar;
    private final BitmapRenderer bitmapRenderer;

    public MapScaleBarLayer(SiweidgMap map, MapScaleBar mapScaleBar) {
        super(map);
